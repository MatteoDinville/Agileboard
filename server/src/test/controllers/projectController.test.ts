...
describe('ProjectController', () => {
	...
	describe('updateProject', () => {
		...
		it('should call next on db error (updateProject)', async () => {
			...
			mockPrisma.project.findUnique.mockResolvedValue({ id: 1, ownerId: 1, title: 't', description: 'd', status: 'En attente', priority: 'Basse' })
	...
	describe('removeProjectMember', () => {
		it('should return 404 when not owner', async () => {
			...
			await projectController.removeProjectMember(
				mockRequest as AuthRequest,
				mockResponse as Response,
				mockNext
			)
