		...
		<div className="min-h-screen bg-white dark:bg-gray-950">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex justify-between items-center h-16">
						<div className="flex items-center space-x-3">
							...
							<span className="text-2xl font-bold text-blue-600 dark:text-blue-400 bg-clip-text">
								Agileboard
							</span>
						</div>
						...
						<div className="flex items-center space-x-4">
							<Link
								to="/login"
								className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white px-4 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
							>
								Connexion
							</Link>
							<Link
								to="/register"
								className="bg-gradient-to-r bg-blue-600 dark:[background-image:none] dark:hover:bg-blue-700 text-white px-6 py-2 rounded-lg hover:bg-blue-700 shadow-lg"
							>
								S'inscrire
							</Link>
						</div>
			...
			<section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
				<div className="text-center">
					...
					<div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
						<Link
							to="/register"
							className="bg-blue-600 dark:bg-blue-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-blue-700 dark:hover:bg-blue-700 shadow-xl hover:shadow-2xl transform hover:scale-105 flex items-center space-x-2"
						>
							<span>Commencer gratuitement</span>
							<ArrowRight className="w-5 h-5" />
						</Link>

						<button className="flex items-center space-x-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white px-8 py-4 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
						<div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:[background-image:none] dark:bg-gray-900/60 backdrop-blur-sm rounded-2xl p-6 border border-blue-100/50 dark:border-gray-800">
							<div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">500+</div>
							<div className="text-gray-600 dark:text-gray-300">Projets créés</div>
						</div>
						<div className="bg-gradient-to-br from-cyan-50 to-sky-50 dark:[background-image:none] dark:bg-gray-900/60 backdrop-blur-sm rounded-2xl p-6 border border-cyan-100/50 dark:border-gray-800">
							<div className="text-3xl font-bold text-sky-600 dark:text-sky-400 mb-2">150+</div>
							<div className="text-gray-600 dark:text-gray-300">Utilisateurs actifs</div>
						</div>
						<div className="bg-gradient-to-br from-sky-50 to-blue-50 dark:[background-image:none] dark:bg-gray-900/60 backdrop-blur-sm rounded-2xl p-6 border border-sky-100/50 dark:border-gray-800">
			...
			<section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					<div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:[background-image:none] dark:bg-gray-900/60 rounded-2xl p-8 shadow-lg shadow-blue-100/50 dark:shadow-black/20 border border-blue-100 dark:border-gray-800 hover:shadow-xl hover:shadow-blue-200/50 transition-all">
						<div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-cyan-500 dark:[background-image:none] dark:bg-blue-600 rounded-xl flex items-center justify-center mb-6">
							<CheckCircle className="w-6 h-6 text-white" />
						</div>
						<h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Suivi de statut</h3>
						<p className="text-gray-600 dark:text-gray-300">
							Suivez l'avancement de vos projets avec des statuts clairs : En attente, En cours, Terminé.
						</p>
					</div>

					<div className="bg-gradient-to-br from-cyan-50 to-sky-50 dark:[background-image:none] dark:bg-gray-900/60 rounded-2xl p-8 shadow-lg shadow-cyan-100/50 dark:shadow-black/20 border border-cyan-100 dark:border-gray-800 hover:shadow-xl hover:shadow-cyan-200/50 transition-all">
						<div className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-sky-500 dark:[background-image:none] dark:bg-cyan-600 rounded-xl flex items-center justify-center mb-6">
							<Star className="w-6 h-6 text-white" />
						</div>
						<h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Gestion des priorités</h3>
						<p className="text-gray-600 dark:text-gray-300">
							Organisez vos tâches par priorité (Basse, Moyenne, Haute) pour une meilleure productivité.
						</p>
					</div>

					<div className="bg-gradient-to-br from-sky-50 to-blue-50 dark:[background-image:none] dark:bg-gray-900/60 rounded-2xl p-8 shadow-lg shadow-sky-100/50 dark:shadow-black/20 border border-sky-100 dark:border-gray-800 hover:shadow-xl hover:shadow-sky-200/50 transition-all">
						<div className="w-12 h-12 bg-gradient-to-br from-sky-500 to-blue-500 dark:[background-image:none] dark:bg-sky-600 rounded-xl flex items-center justify-center mb-6">
